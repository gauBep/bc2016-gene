...
//    System.out.println(" Entity count: " +  model.getEntities().size());
...
//		if (node.getContent() != null && node.getContent().toString().contains("Caroline")) {
//			System.err.format("point=%s content class=%s content=%s \n shape=%s", 
//					node.getPosition(), 
//					node.getContent().getClass(), 
//					node.getContent(),
//					node.getShape()
//					
//			).println();
...
//				Fam fam = (Fam)content;
//				System.err.format("displayValue=%s, husband=%s, wife=%s, children=%s ", 
//						fam.getDisplayValue(),
//						getInfo(fam.getHusband()),
//						getInfo(fam.getWife()),
//						Arrays.toString(fam.getChildren())
//						
//					)
//				.println();
//			}
...
//  private String getInfo(Indi indi){
//	  if(indi == null){
//		  return null;
//	  }
//	  return String.format("%s %s %s", indi.getFirstName(), indi.getLastName(), indi.getBirthAsString());
//  }
