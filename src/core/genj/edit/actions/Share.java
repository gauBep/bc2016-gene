 ...
 * Undo on Gedcom
 */  
public class Share extends Action2 implements GedcomMetaListener {
   ...
   * Constructor
   */
  public Share(Gedcom gedcom, boolean enabled) {
    
    // setup looks
    setImage(Images.imgShare);
